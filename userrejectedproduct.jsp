...
<head>
  ...
  <title>Bid Time - Rejected Product</title>
        ...
        <div class="billing_details">
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-8 col-md-7">
                    <h3 style="padding-top: 15px;padding-bottom: 15px;font-size: 22px;">Rejected Product Details</h3>
          <!-- Start Best Seller -->
            ...
            <div class="row">
                 <% 
                    try {
                        ...
                        ResultSet rs;
                        rs = st.executeQuery("Select prd_id,prd_name,category_name,min_bid,prd_img from vw_product where seller_name='" + session.getAttribute("user") + "' and adminconfirm='No' order by bid_date");
                        while(rs.next())
                        { %>
