...
<head>
  ...
  <title>Bid Time - Sold Product</title>
        ...
        <div class="billing_details">
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-8 col-md-7">
                    <h3 style="padding-top: 15px;padding-bottom: 15px;font-size: 22px;">Sold Product Details</h3>
          <!-- Start Best Seller -->
            ...
            <div class="row">
                 <% 
                    try {
                        ...
                        ResultSet rs;
                        rs = st.executeQuery("Select prd_name,category_name,bid_amt,prd_img from vw_product where seller_name='" + session.getAttribute("user") + "' and adminconfirm='Sold'");
                        while(rs.next())
                        { %>
                        <div class="col-md-6 col-lg-4">
                            <div class="card text-center card-product">
                              <div class="card-product__img">
                                  <img class="card-img" style="width: 270px; height: 300px" src="product_images/<%= rs.getString(4) %>" alt="">
                              </div>
                              <div class="card-body">
                                <p><%= rs.getString(2) %></p>
                                <h4 class="card-product__title"><a href="#"><%= rs.getString(1) %></a></h4>
                                <p class="card-product__price">Rs.<%= rs.getString(3) %></p>
                              </div>
                            </div>
                        </div> 
                       <% }
